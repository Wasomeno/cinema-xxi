...
const AppNavigationMobile = () => {
  ...
  return (
    <div className="sticky bottom-0 z-10 flex h-16 w-full items-center justify-evenly border-t shadow-md backdrop-blur-md dark:border-slate-700 dark:bg-slate-900 md:hidden">
      {appPaths.map((path) => (
        <Link
          key={path.text}
          href={path.href}
