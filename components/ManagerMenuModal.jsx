...
const ManagerMenuModal = ({ closeModal }) => {
  ...
  return (
    <ModalContainer closeModal={closeModal}>
      <AnimatedContainer className="fixed bottom-0 z-20 flex h-80 w-full flex-col gap-4 rounded-t-lg bg-slate-100 p-4 dark:bg-slate-700 md:right-5 md:top-12 md:h-96 md:w-80 md:rounded-lg">
