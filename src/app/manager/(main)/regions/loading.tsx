...
import { RegionsTableRowSkeletons } from "@/components/Manager/Regions/regions-table-row-skeletons"
      ...
      <AnimatedContainer className="mt-2 flex w-full flex-1 flex-col">
        <div className="my-2 flex justify-between gap-2.5">
          <div className="flex items-center gap-2">
            ...
            />
            <TableDataSorter sorts={regionSorts} />
          </div>
          ...
          <Table>
            <Table.Head>
              <tr>
                ...
                <th className="px-6 py-4 text-center font-medium text-gray-900 dark:text-slate-100"></th>
              </tr>
            </Table.Head>
            <Table.Body>
              <RegionsTableRowSkeletons />
            </Table.Body>
          </Table>
        </div>
