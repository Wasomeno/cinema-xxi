...
import { CinemaAdminsTableRowSkeletons } from "@/components/Admin/Admins/cinema-admins-table-row-skeleton"
import { AnimatedContainer } from "@/components/animated-container"
import { AdminHeader } from "@/components/Headers/admin-header"
import Table from "@/components/table"
import { TableDataSorter } from "@/components/table-data-sorter"

export default function CinemaAdminsLoading() {
  return (
      ...
      <AnimatedContainer className="mt-2 flex w-full flex-1 flex-col">
        <div className="my-2 flex justify-between gap-2.5">
          <div className="flex items-center gap-2">
            ...
            />
            <TableDataSorter disabled sorts={adminSorts} />
          </div>
